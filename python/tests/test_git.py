...
from memoro.errors import RepositoryError
from memoro.git import GIT_IDENTITY_EMAIL, GIT_IDENTITY_NAME, GitRepository, _git_environment
from memoro.markdown import memory_revision
...
def test_create_and_replace_create_two_commits(
    ...
    assert subjects == ['memory(persona): replace "Fact"', 'memory(persona): create "Fact"']
